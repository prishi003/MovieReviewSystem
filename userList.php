...
<body>
   ...
   <?php
		...
		if (mysqli_num_rows($result) > 0) {
			 ...
			 echo '<table class="table table-hover" style="margin-left:2em;">
    <tr style="font-size:40px; font-weight:bold; color:rgb(100,100,155); ">
       <th>First Name</th>
       <th>Last Name</th>
       <th>Gender</th>
       <th>Birthdate</th>
       ...
       <th>Username</th>
		    ...
		    while($row = mysqli_fetch_assoc($result)) {
		        echo " <tr style='font-size:24px; color:rgb(169,169,169);'>";
                    echo "<td>";
